...
- `user-service` user list now aggregates student, teacher, and admin accounts; login, password reset, and password change endpoints have concrete student/teacher/admin implementations.
